...
@Injectable()
export class LineSeparatorsResolver implements Resolve<Definition> {

    constructor(protected generalParameterService: GeneralParameterService) {}

    resolve(route: ActivatedRouteSnapshot): any {
        return this.generalParameterService.getValueByKey('input-configuration-line-separators');
    }
